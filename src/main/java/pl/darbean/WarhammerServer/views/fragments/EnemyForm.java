...
public class EnemyForm extends HorizontalLayout {
    ...
    public EnemyForm(FighterFormModel fighterFormModel, Map<String, Fighter> initiativeMap) {
        ...
        comboBox.addValueChangeListener(event -> fighterFormModel.setType(event.getValue()));
        ...
        numberField.addValueChangeListener(event -> fighterFormModel.setQuantity(event.getValue()));
        add(numberField);
        ...
        baseEnemyHealth.addValueChangeListener(event -> fighterFormModel.setBaseHealth(event.getValue()));
        ...
        randomizer.setMin(0);
        randomizer.addValueChangeListener(event -> fighterFormModel.setRandomizer(event.getValue()));
